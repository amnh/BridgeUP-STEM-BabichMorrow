...
| **Week 25** | | |
  ...
  | April 11 | <ul><li> Meet Peri Doerfler! </li><li> Finish updating Maxent model script </li><li> Future climate data :fast_forward: </li><li> Start projecting forward in time </li><li> Talk about elevator pitches |                                                   [Back to the future - climate data](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/s7_project_in_time/Future_climate_data.md) <br> [Projecting forward tutorial](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/s7_project_in_time/project_forward_tutorial.Rmd) |
| **Week 26** | | |
  | April 16 | <ul><li> Meet with Mary Blair! </li><li> Projecting forward in time (continued) </li><li> Update R script </li><li> Past climate data :rewind: |                                                                                                         [Turn back time - climate data](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/s7_project_in_time/Past_climate_data.md) |
  | April 18 | <ul><li> Projecting backwards in time| Projecting backward tutorial |
