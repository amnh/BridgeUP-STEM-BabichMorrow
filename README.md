...
|----------|-------------|------|
| **Week 12** | | |
  | January 3 | <ul><li> GitHub pull requests </li><li> File path game |                                                                   [File path game instructions](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/File_Paths/Path_Game.md) <br> |
| **Week 13** | | |
