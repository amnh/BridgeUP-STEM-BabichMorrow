...
| **Week 4** | | |
  ...
  | November 1 | <ul><li> `ggplot2` tutorial </li><li> Lines & polygons :triangular_ruler: |                                     [`ggplot2` tutorial](https://www.datacamp.com/courses/data-visualization-with-ggplot2-1) <br> Return to GPS - RMarkdown |
| **Week 5** | | |
