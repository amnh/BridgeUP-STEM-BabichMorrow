...
| **Week 25** | | |
  ...
  | April 11 | <ul><li> Meet Peri Doerfler! </li><li> Getting help with R </li><li> Finish updating Maxent model script </li><li> Future climate data :fast_forward: </li><li> Talk about elevator pitches |                                                 [Debugging workflow](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/Resources/Debugging_workflow.md) <br> [`saveRDS()` function example](http://www.endmemo.com/program/R/saverds.php) <br> [Back to the future - climate data](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/s7_project_in_time/Future_climate_data.md) |
| **Week 26** | | |
  | April 16 | <ul><li> Meet with Mary Blair! </li><li> Projecting forward in time </li><li> Update R script | [Projecting forward tutorial](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/s7_project_in_time/project_forward_tutorial.Rmd) |
