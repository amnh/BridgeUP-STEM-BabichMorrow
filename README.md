...
| **Week 9** | | |
  | December 4 | <ul><li> Wrap up spatial thinning </li><li> Introduction to rasters </li><li> What is WorldClim? |             [Polygon overlap revisited](https://docs.google.com/presentation/d/1VzmFvZxlq0hjCQCn3RYNRr9m_RY1ZUqj8TsK8rS2BAo/edit?usp=sharing) <br> [Intro to rasters - slides](https://docs.google.com/presentation/d/1MQMfrr6dFnPqvtxN5eqYqkOdbTS5NkUvMaKpuUI-v9Q/edit?usp=sharing) <br> [WorldClim website](http://www.worldclim.org): [Data format](http://www.worldclim.org/formats1) & [Bioclimatic variables](http://www.worldclim.org/bioclim) |
  | December 6 | <ul><li> `raster` package tutorial </li><li> WorldClim in R :earth_americas: |                                 [`raster` tutorial](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/obtain_env_data/raster_tutorial.Rmd) <br> [WorldClim in R Rmd](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/obtain_env_data/worldclim_inR.Rmd) |
| **Week 10** | | |
