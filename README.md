...
| **Week 9** | | |
  | December 4 | <ul><li> Wrap up spatial thinning </li><li> Introduction to rasters </li><li> `raster` package tutorial |             [Polygon overlap revisited](https://docs.google.com/presentation/d/1VzmFvZxlq0hjCQCn3RYNRr9m_RY1ZUqj8TsK8rS2BAo/edit?usp=sharing) <br> [Intro to rasters - slides](https://docs.google.com/presentation/d/1MQMfrr6dFnPqvtxN5eqYqkOdbTS5NkUvMaKpuUI-v9Q/edit?usp=sharing) <br> [`raster` tutorial](https://www.neonscience.org/primer-raster-data-r) |
  | December 6 | <ul><li> What is WorldClim? </li><li> WorldClim in R :earth_americas: | [WorldClim website](http://www.worldclim.org): [Data format](http://www.worldclim.org/formats1) & [Bioclimatic variables](http://www.worldclim.org/bioclim) |
| **Week 10** | | |
