...
| **Week 14** | | |
  | January 15 | <ul><li> Introduction to machine learning (continued) </li><li> Machine learning in the real world </li><li> Machine learning in R |                                                                                                         [Machine learning articles](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/machine_learning/ML_articles.md) <br> [Iris machine learning project - slides](https://docs.google.com/presentation/d/1dLnjxI7--hQtiehWNztXQ7rFRAFkpjkB_h4NpTzQM0M/edit?usp=sharing) <br> [Hello machine learning! - RMarkdown](https://github.com/amnh/BridgeUP-STEM-BabichMorrow/blob/master/lesson_plans/machine_learning/intro_machinelearning.Rmd)|
  | January 17 | <ul><li> Hello machine learning project (continued) | |
| **Week 15** | | |
