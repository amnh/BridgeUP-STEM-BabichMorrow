...
**Try it yourself:** Replace "Tetracheilostoma carlae" with the scientific name of the organism you learned about in the Hall of Biodiversity and run `occ`.
...
Now we want to add the occurrence data to our map. The following code looks a lot like the code we used to map your points in Central Park -- the process of plotting species occurrence points is the same as the process to plot GPS points you took yourself.
...
+ Save it in the lesson_plans/obtain_occ_data/ folder
