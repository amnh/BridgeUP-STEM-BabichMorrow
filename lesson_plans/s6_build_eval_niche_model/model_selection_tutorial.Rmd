...
```{r}
# name each model in our evalMods object
names(evalMods) <- enm@results$settings
# select just the model you want
model <- evalMods[["L_1"]]
```
